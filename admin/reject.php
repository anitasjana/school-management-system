...
?>
    ...
    <div class="body_search_display">
        ...
        <div class="body_search_add">
            ...
            <!-- <a href="addusers.php"><div class="body_search_student_color rejected"><i class="fa-solid fa-circle-xmark"></i>
    ...
    <table class="maintable">
        ...
        $b="select * from leave_approve where status='2'";
        ...
        while($row=mysqli_fetch_assoc($c)){
            ...
            <tr style="background: #e4ebedb8; box-shadow: 0px 0px 5px 0px rgb(197, 197, 197);">
                ...
                <td>
                <button class="ss2">reject</button>
            </td>
            </tr>
            <?php
                   $v++;   
